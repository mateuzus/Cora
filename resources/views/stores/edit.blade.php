...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Edição de loja - {{$store->name}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('stores.index') }}">Listagem das lojas</a></li>
                <li class="breadcrumb-item active">Edição de loja - {{$store->name}}</li>
            </ol>
        </div>
    </div>
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Edição de Loja</h3>
                    </div>
                    <div class="card-body">
