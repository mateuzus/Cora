...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Edição de fonte de dados - {{$fontDatas->name}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('fontDatas.index') }}">Fonte de dados</a></li>
                <li class="breadcrumb-item active">Edição de Fonte de dados</li>
            </ol>
        </div>
    </div>
@endsection
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    {{ Form::model($fontDatas, [
                            'url'=>route("fontDatas.update", $fontDatas->id),
                             'files'=>true,
                             'method'=>"put"
                     ]) }}
                    <div class="card-header">
                        <h3 class="card-title">Edição de Fonte de dados - <b>{{$fontDatas->name}}</b></h3>
                    </div>
                    <div class="card-body">
