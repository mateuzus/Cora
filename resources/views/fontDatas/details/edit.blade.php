...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    {{ Form::model($fontDataDetail, [
                            'url'=>route("fontDataDetail.update", $fontDataDetail->id),
                             'files'=>true,
                             'method'=>"put"
                     ]) }}
                    <div class="card-header">
                        <h3 class="card-title">Edição de Fonte de dados - <b>{{$fontDataDetail->ean_code}}</b></h3>
                    </div>
                    <div class="card-body">
                        @include('fontDatas.details._form')
                    </div>
